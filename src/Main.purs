...
import Halogen.Bootstrap5.Bootstrap (col4, col6, col7, dFlex, formFloating, justifyContentEnd, justifyContentLgStart, justifyContentSmEnd, justifyContentStart)
import Halogen.Frameworks.Bootstrap (bi, btn, btnClose, btnGroup, btnSecondary, col, col1, col10, col2, col5, col8, dGrid, formControl, fs2, fwBolder, h75, justifyContentCenter, justifyContentLgEnd, mb2, me1, ms1, mt2, offcanvas, offcanvasBody, offcanvasBottom, offcanvasHeader, offcanvasTitle, p0, p1, pb0, pb2, pe0, pe2, pe3, ps0, ps1, ps2, ps3, pt0, pt1, pt2, row, textCenter, textReset)
